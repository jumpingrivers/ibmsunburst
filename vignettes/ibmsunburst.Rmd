...
The actual use of the package is to apply it on the output from [IBM Personality Insight API](https://www.ibm.com/watson/developercloud/personality-insights/api/v3/). `ibmsunburst::ibmsunburst()` accept the data as list, JSON or path to file.
